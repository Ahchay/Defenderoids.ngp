...
const u8 HeightMap[] = {
						...
						98,99,100,99,100,99,98,97,98,99,100,101,102,101,100,100
					};
...
const COLOURPOINT PlayerSprite[] = {
							                           ...
							                           {3,3,1}, {5,3,1},
							                           {3,4,1}, {5,4,1},
							{0,5,2},                   {3,5,1}, {5,5,1},                   {8,5,2},
							{0,6,2},          {2,6,1}, {3,6,1}, {5,6,1}, {6,6,1},          {8,6,2},
							{0,7,1},          {2,7,1}, {3,7,2}, {5,7,2}, {6,7,1},          {8,7,1},
							{0,8,1},          {2,8,1}, {3,8,2}, {5,8,2}, {6,8,1},          {8,8,1},
							         {1, 9,1},{2,9,3}, {3,9,1}, {5,9,1}, {6,9,3}, {7,9,1},
