...
const COLOURPOINT PlayerSprite[] = {
							...
							{0,3,0},{1,3,0},{2,3,0},{3,3,1},{4,3,0},{5,3,0},{6,3,0},
							{0,4,2},{1,4,0},{2,4,1},{3,4,1},{4,4,1},{5,4,0},{6,4,2},
							{0,5,2},{1,5,0},{2,5,1},{3,5,2},{4,5,1},{5,5,0},{6,5,2},
							{0,6,1},{1,6,0},{2,6,2},{3,6,1},{4,6,2},{5,6,0},{6,6,1},
							{0,7,1},{1,7,1},{2,7,1},{3,7,1},{4,7,1},{5,7,1},{6,7,1},
							{0,8,1},{1,8,1},{2,8,3},{3,8,1},{4,8,3},{5,8,1},{6,8,1},
							{0,9,1},{1,9,0},{2,9,3},{3,9,1},{4,9,3},{5,9,0},{6,9,1}
						};